 ...
 <div>
  ...
  <div class="upload_warp">
   <div class="upload_warp_img">
    <div class="upload_warp_img_div" v-for="(item,index) in imgList" :key="item">
     <div class="upload_warp_img_div_top">
      <img src="http://tbcdn.tajansoft.com/test1.png" class="upload_warp_img_div_del" @click="fileDel(index)">
     </div>
    ...
    <div class="upload_warp_left" id="upload_warp_left" @click="fileClick()" v-if="this.imgList.length < 6">
     ...
     <!-- <img src="http://tbcdn.tajansoft.com/test1.png" class="imgs"/> -->
    </div>
   </div>
