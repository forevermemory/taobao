...
//      	//console.log('鎴戞槸绗�2涓柟娉�');
      ...
      updateView: function() {
              //椤甸潰鐐瑰嚮鏄剧ず鏃ュ巻鍚庣殑绗笁涓柟娉曪紝
//      		//console.log('鎴戞槸绗�3涓柟娉�');
          if (this.timePicker) {
      ...
      updateMonthsInView: function() {
          //椤甸潰鐐瑰嚮鏄剧ず鏃ュ巻鍚庣殑绗洓涓柟娉曪紝濡傛灉鏈夌粨鏉熸棩鏈燂紝鎴栬€呮病鏈夌粨鏉熸棩鏈�
//      		//console.log('鎴戞槸绗�4涓柟娉�');
          if (this.endDate) {
...
//      	//console.log('鎴戞槸绗�5涓柟娉�');
      ...
      renderCalendar: function(side) {
          //椤甸潰鍒濆鎬庝箞鏄剧ず锛屾樉绀洪€夋嫨鍝釜鏃ユ湡
//      	//console.log('鎴戞槸绗�6涓柟娉�');
...
//      	//console.log('鎴戞槸绗�9涓柟娉�');
      ...
      show: function(e) {
//      	//console.log('鎴戞槸绗�10涓柟娉�');
              //绗簩涓紝濡傛灉椤甸潰娌℃湁鏄剧ず锛岀浜屼釜鏂规硶杩涜繖锛岃鏃ュ巻鏄剧ず
...
//						//console.log('褰撴垜閫夋嫨瀹屼互鍚庡啀娆＄偣鍑绘棩鍘嗗紑濮�'+this.startDate)
//						//console.log('褰撴垜閫夋嫨瀹屼互鍚庡啀娆＄偣鍑绘棩鍘嗙粨鏉�'+this.endDate.clone)
...
//          this.previousRightTime = this.endDate.clone();
          ...
          this.isShowing = true;
          if($('#daterange-btn span').html()=='鍏ㄩ儴'){
...
//          	//console.log('鐜板湪鏄垜鑷繁閫夋嫨鐨�')
              //if a new date range was selected, invoke the user callback function
              if (!this.startDate.isSame(this.oldStartDate) || !this.endDate.isSame(this.oldEndDate)){
//	            		//console.log('杩欐椂鍊欑殑寮€濮�'+this.startDate);
//	            		//console.log(this.endDate)
                  this.callback(this.startDate, this.endDate, this.chosenLabel);
              }
      ...
      toggle: function(e) {
          //鐐瑰嚮鍚庡厛杩涜繖涓柟娉曪紝鍒ゆ柇鏄惁鏄剧ず锛屾樉绀哄垯闅愯棌锛岄殣钘忓垯鏄剧ず
          //console.log('鎴戞槸绗�12涓柟娉�');
          if (this.isShowing) {
              this.hide();
          } else {
              this.show();
      ...
      hideCalendars: function() {
          //console.log('鎴戞槸绗�15涓柟娉�');
          this.container.removeClass('show-calendar');
          this.element.trigger('hideCalendar.daterangepicker', this);
      },

      hoverRange: function(e) {
          //console.log('鎴戞槸绗�16涓柟娉�');
              //榧犳爣婊戣繃姣忎釜td
          //ignore mouse movements while an above-calendar text input has focus
          if (this.container.find('input[name=daterangepicker_start]').is(":focus") || this.container.find('input[name=daterangepicker_end]').is(":focus"))
              return;
